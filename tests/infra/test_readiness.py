...
def test_readiness_returns_200_when_mysql_ok(client) -> None:
...
@pytest.mark.integration
def test_readiness_returns_503_when_mysql_unavailable(client) -> None:
...
@pytest.mark.integration
def test_readiness_content_type_is_json(client) -> None:
