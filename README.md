...
本地工具链由 devbox 提供：Python 3.13、uv、go-task、MySQL 8.0、**Redis 8.0**、**PostgreSQL 16（含 pgvector）**。
...
就绪探针（检查 **MySQL + Redis + PostgreSQL（AI 读库）** 连通性）：
...
| 类别 | 路径 |
|------|------|
| 业务代码 | `app/**`、`tests/**`、`alembic/**`、`alembic_ai/**` |
